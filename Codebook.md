# Code book for accelerometer and gyroscope studies
...
In tidy_data.txt there is information about mean value for each characteristic for each subject and each activity.
